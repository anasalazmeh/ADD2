...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-white text-gray-600 justify-evenly">
        ...
        <nav className="flex justify-center items-center flex-col text-xl">
      ...
      <footer className="footer footer-center p-4 bg-white  text-gray-600 border-t border-gray-200 text-xl">
        <aside>
